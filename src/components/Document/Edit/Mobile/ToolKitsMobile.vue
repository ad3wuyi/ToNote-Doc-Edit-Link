<template>
  <div class="tool p-2 d-flex justify-content-between align-items-center gap-1 flex-wrap">
    <li class="btn blue rounded-circle d-flex justify-content-center align-items-center" @click="
      isSignerSelected({
        toolId: 'textTool',
        tool_name: 'Textarea',
      })
    ...
    ">
      <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" class="ml-auto tool-svg">
        <g clip-path="url(#a)">
          <path
    ...
    <li class="btn d-none rounded-circle d-flex justify-content-center align-items-center" @click="
      isSignerSelected({
        toolId: 'dateTool',
        tool_name: 'Date',
      })
    ">
      <svg width="21" height="21" xmlns="http://www.w3.org/2000/svg" class="ml-auto tool-svg">
        <path
...
const { profile } = useGetters({ profile: "auth/profile" });
